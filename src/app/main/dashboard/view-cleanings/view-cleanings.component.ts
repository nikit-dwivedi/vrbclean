...
@Component({
  selector: 'app-view-cleanings',
  templateUrl: './view-cleanings.component.html',
  styleUrls: ['./view-cleanings.component.scss']
})
export class ViewCleaningsComponent implements OnInit {
