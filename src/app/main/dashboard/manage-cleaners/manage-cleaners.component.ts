...
@Component({
  selector: 'app-manage-cleaners',
  templateUrl: './manage-cleaners.component.html',
  styleUrls: ['./manage-cleaners.component.scss']
})
export class ManageCleanersComponent implements OnInit {
        ...
        links: [
          {
            ...
            isLink: true,
            link: 'dashboard/manage-cleaners'
          }
        ]
      }
    }
